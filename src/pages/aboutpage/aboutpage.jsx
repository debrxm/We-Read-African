    ...
    <div className="aboutpage">
      ...
      <div className="left">
        ...
        <p>
          ...
          <br />
          <br />
          Here you'll find weekly book reviews, beautiful bookstores from around
          the world, literary city guides and some personal insights into the
          life of an expat, all written lovingly from my beach-side bedroom.
        </p>
      </div>
    </div>
  );
